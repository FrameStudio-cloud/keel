...
export default function SlowMovingStock({ compact }) {
  ...
  if (isLoading) {
    return (
      <div className="bg-white dark:bg-[#16213e] border border-slate-200 dark:border-white/10 rounded-2xl shadow-sm p-5 h-full">
  ...
  return (
    <div className="bg-white dark:bg-[#16213e] border border-slate-200 dark:border-white/10 rounded-2xl p-5 h-full">
      <h3 className="text-slate-900 dark:text-white font-semibold text-sm mb-4">
        Slow Moving Stock
      </h3>
