...
export default function IntegrationsTab() {
  ...
  return (
    <SectionCard icon={FiCalendar} title="Google Calendar">
      <p className="text-xs text-gray-500 dark:text-slate-400 mb-4">
        Sync service order appointments to your Google Calendar. Each scheduled order creates a calendar event.
      </p>
      {calLoading ? (
        ...
        <div className="text-center py-4">
          <p className="text-xs text-gray-400 dark:text-slate-500 mb-4">
            Connect your Google Calendar to auto-schedule service appointments.
          </p>
          <button
            onClick={async () => {
