...
INSERT INTO catalogue (shop_id, name, type, category, price, price_label, image, available, featured, badge, description, variants, specs, includes) VALUES
  ('00000000-0000-0000-0000-000000000001', 'iPhone 15 Pro Max Case',       'product', 'Cases',     1800, 'Ksh 1,800', 'https://picsum.photos/seed/case1/400/400', true, true,  'Best Seller', 'Premium silicone case with shockproof protection.', '{"colors":["Black","Blue","Clear"]}',             ARRAY['Premium silicone','Shockproof','Wireless charging compatible'],              ARRAY['1x Case']),
  ('00000000-0000-0000-0000-000000000001', 'Samsung Galaxy S24 Ultra Case','product', 'Cases',     1500, 'Ksh 1,500', 'https://picsum.photos/seed/case2/400/400', true, true,  null,         'Military-grade drop protection with a soft-touch finish.', '{"colors":["Black","Green","Purple"]}',           ARRAY['Military-grade drop protection','Soft-touch finish'],                        ARRAY['1x Case']),
  ('00000000-0000-0000-0000-000000000001', 'Bluetooth Wireless Earbuds',   'product', 'Audio',     2500, 'Ksh 2,500', 'https://picsum.photos/seed/buds/400/400',   true, false, null,         'High-quality wireless earbuds with 24hr battery life.', '{"colors":["White","Black"]}',                    ARRAY['Bluetooth 5.3','24hr battery','IPX5 waterproof'],                           ARRAY['Earbuds','Charging case','3x ear tips']),
  ('00000000-0000-0000-0000-000000000001', 'USB-C Fast Charger 65W',       'product', 'Chargers',  2200, 'Ksh 2,200', 'https://picsum.photos/seed/charger/400/400', true, false, null,         'GaN technology fast charger with foldable plug.', '{}',                                               ARRAY['GaN technology','65W PD 3.0','Foldable plug'],                              ARRAY['Charger','USB-C cable']),
  ('00000000-0000-0000-0000-000000000001', 'Power Bank 20000mAh',          'product', 'Chargers',  3500, 'Ksh 3,500', 'https://picsum.photos/seed/powerbank/400/400',true, false, null,         'High capacity power bank with PD 45W fast charging.', '{"colors":["Black","White"]}',                    ARRAY['20000mAh','PD 45W','LED display'],                                            ARRAY['Power bank','USB-C cable']),
  ('00000000-0000-0000-0000-000000000001', 'Smart Watch Band 22mm',        'product', 'Wearables',  500, 'Ksh 500',   'https://picsum.photos/seed/band/400/400',   true, false, 'New',        'Comfortable silicone band with quick-release pins.', '{"colors":["Black","Brown","Blue","Red"]}',       ARRAY['Silicone','Quick-release pins','Adjustable'],                                ARRAY['1x band']),
  ('00000000-0000-0000-0000-000000000001', 'AirPods Pro 2 Case Cover',     'product', 'Cases',      400, 'Ksh 400',   'https://picsum.photos/seed/airpodcase/400/400',true,false, null,         'Silicone gel cover with carabiner for your AirPods.', '{"colors":["Black","Pink","Blue","Green"]}',      ARRAY['Silicone gel','Shock-absorbent','Includes carabiner'],                        ARRAY['1x cover']);
